...
(function () {
    ...
    function save(action) {
        return fetch(DATA.endpoint, {
            ...
            body: JSON.stringify({ action: action || "save", section: state.section, answers: state.answers, contact: state.contact })
        ...
        var newMain = E("div", { class: "pe-main", "data-pe-main": "" }, [
            ...
            E("div", { class: "pe-review" }, [
                ...
                E("div", { class: "pe-result" }, [
                    ...
                    contactCard(),
                    E("button", { class: "pe-btn pe-btn--white pe-submit", type: "button", html: "<span>Evaluate my profile</span><span class=\"pe-submit__arrow\" aria-hidden=\"true\">&rarr;</span>", onclick: submit }),
