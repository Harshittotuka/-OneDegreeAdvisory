<form data-consult-form class="contact-form" action="{{ route('contact.submit') }}" method="POST">
  ...
  <p class="contact-privacy">By submitting, you agree to our <a href="{{ route('terms') }}">Terms &amp; Conditions</a> and <a href="{{ route('privacy') }}">Privacy Policy</a>. We never share your data.</p>
