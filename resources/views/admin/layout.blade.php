  ...
  @php
    ...
    $brandSub = $isSuper ? 'Super Admin · Content Studio' : 'Content Studio';
      $pageItems = [
        ...
        ['label' => 'Career Counselling', 'icon' => 'compass', 'route' => 'admin.career-counselling.index', 'match' => 'admin.career-counselling'],
        ['label' => 'Trending Career', 'icon' => 'library', 'route' => 'admin.career-library.index', 'match' => 'admin.career-library'],
