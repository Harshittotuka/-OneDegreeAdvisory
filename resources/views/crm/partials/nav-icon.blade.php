@switch($name)
    ...
    @case('team')
        ...
        @break
    @case('partner-codes')
        <svg viewBox="0 0 24 24" aria-hidden="true"><path d="M20.5 12.5 12.5 20.5a2 2 0 0 1-2.8 0l-6.2-6.2a2 2 0 0 1 0-2.8L11.5 3.5a2 2 0 0 1 1.7-.6l6 .9a2 2 0 0 1 1.7 1.7l.9 6a2 2 0 0 1-.6 1.7Z"/><circle cx="16" cy="8" r="1.6"/></svg>
        @break
    @case('spam')
