...
class ProfileReportBuilder
{
    ...
    private const DISPLAY_LABELS = [
        ...
        'your ibdp point score (24 - 45) ( if from ib board or else keep it blank)' => 'IBDP Point Score (24–45)',
        ...
        'gre score' => 'GRE Score',
        'any budget constraint (total program cost)' => 'Budget Constraint (Total Program Cost)',
