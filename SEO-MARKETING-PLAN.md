...
| **Test site (`*.nip.io`) forced to `noindex` + `Disallow: /`** | The UAT box runs as `production` and was fully indexable — a duplicate of the live site that would compete with it. Now only `onedegreeadvisory.com` can be crawled/indexed. |
